...
@section('content')
    <div class="card">
        <form action="{{route('season.store',$series->id)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
            @csrf
            <div class="card-header">
                <strong>Create new Season  to : <a href="{{route('series.edit',$series->id)}}">{{$series->title}}</a></strong>
            </div>
